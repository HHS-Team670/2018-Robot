...
/**
 *Does Encoders Drive without Ramp Rate adjustment. Might drive straighter than the other one
 */
public class Encoders_Drive_Simple extends LoggingCommand {
	...
	public Encoders_Drive_Simple(double inches) {
		this.inches = inches;
